...
const sendOTPemail = asyncHandler(async ({ _id, email }, res) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Your Expense-Tracker Account Verification OTP",
    html: `
    <html>
      <head>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2>OTP Verification for Expense-Tracker Account</h2>
          </div>
          <div class="content">
            <p>Dear User,</p>
            <p>Your OTP for verifying your Expense-Tracker account is: <strong>${otp}</strong></p>
