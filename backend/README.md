...
Welcome to the backend repository of Expense-Tracker - your go-to platform for effortless financial management. This repository contains all the backend code necessary to power the Expense-Tracker application.

<hr/>

## Getting Started

Follow these steps to set up the Expense-Tracker backend on your local machine:
...
- The development server will start running at http://localhost:3000, and you can access Expense-Tracker's backend routes from there.
